package com.example.fangjingdong.view.util;
...
public class JieKou {
    ...
    //添加购物车...uid...pid
    public static final String ADD_CART = BASE_URL+"product/addCart";
    //注册
    public static final String ZHUCE_URL=BASE_URL+"user/reg";
