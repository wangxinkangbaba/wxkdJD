...
import com.example.fangjingdong.view.presenter.UpLoadPicPresenter;
import com.example.fangjingdong.view.presenter.UserInfoPresenter;
...
public class Gerenzhongxin extends AppCompatActivity implements View.OnClickListener, UpLoadActivityInter, UserInforInter {
...
//父窗体的视图
        parent = View.inflate(Gerenzhongxin.this, R.layout.activity_user_info,null);

        View contentView = View.inflate(Gerenzhongxin.this,R.layout.upload_pop_layout,null);
...
//加载圆形
        GlideImgManager.glideLoader(Gerenzhongxin.this, CommonUtils.getString("iconUrl"), R.drawable.user, R.drawable.user, setting_icon, 0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2000 && resultCode == RESULT_OK) {
            ...
            try {
                ...
                upLoadPicPresenter.uploadPic(JieKou.UPLOAD_ICON_URL,saveIconFile,CommonUtils.getString("uid"),"touxiang.jpg");
    ...
    public void uploadPicSuccess(UpLoadPicBean upLoadPicBean) {
        if ("0".equals(upLoadPicBean.getCode())) {
            Toast.makeText(Gerenzhongxin.this,"上传成功",Toast.LENGTH_SHORT).show();

            //上传成功之后需要获取用户信息,,,
            userInfoPresenter.getUserInfo(JieKou.USER_INFO_URL,CommonUtils.getString("uid"));
    ...
    public void onUserInforSuccess(UserInfoBean userInfoBean) {
        if ("0".equals(userInfoBean.getCode())) {
            ...
            GlideImgManager.glideLoader(Gerenzhongxin.this, userInfoBean.getData().getIcon(), R.drawable.user, R.drawable.user, setting_icon, 0);
