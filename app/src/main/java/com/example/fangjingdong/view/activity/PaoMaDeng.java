...
public class PaoMaDeng extends TextView{
    ...
    private List<PaoMaBean> mTexts; //显示文字的数据源
    ...
    public void setOnClickLitener(PaoMaDeng.onClickLitener onClickLitener) {
    ...
    public PaoMaDeng(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (mTexts != null) {
            Log.i(TAG, "onDraw: " + mY);
            //获取当前的数据
            PaoMaBean model = mTexts.get(mIndex);
