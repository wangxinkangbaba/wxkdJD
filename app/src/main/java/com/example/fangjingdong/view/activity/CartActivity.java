...
public class CartActivity extends AppCompatActivity implements IBannerMain,FragmentCartInter, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tui_jian_recycler = (RecyclerView) findViewById(R.id.tui_jian_recycler);
        my_expanable_view = (MyExpanableView) findViewById(R.id.my_expanable_view);
        relative_progress = (RelativeLayout) findViewById(R.id.relative_progress);
        cart_check_all = (CheckBox) findViewById(R.id.cart_check_all);
    ...
    public void IBannerSucces(final BannerBean bannerBean) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                TuiJianAdapter tuiJianAdapter = new TuiJianAdapter(tuijian, CartActivity.this);
                ...
                tuiJianAdapter.OnItemClick(new ClickListener() {
                    ...
                    public void OnitemClicklistener(int position) {
                        ...
                        Intent intent = new Intent(CartActivity.this, Xiangqing.class);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.text_buy://去结算
                ...
                //选中了商品之后,,,跳转到确认订单页面
                Intent intent = new Intent(CartActivity.this, Querendingdan.class);
